...
class Products extends LocalAPI
{
    ...
    public function addProduct(
        ...
        return self::call('AddProduct', self::payload([
            ...
            'proratadate' => $prorata_date,
            'proratachargenextmonth' => $prorata_charge_next_month,
            'subdomain' => $subdomain,
            'autosetup' => $auto_setup,
            'module' => $module,
            'servergroupid' => $server_group_id,
            'configoption1' => $config_option1,
            'configoption2' => $config_option2,
            'configoption3' => $config_option3,
            'configoption4' => $config_option4,
            'configoption5' => $config_option5,
            'configoption6' => $config_option6,
            'order' => $order,
            'pricing' => $pricing,
